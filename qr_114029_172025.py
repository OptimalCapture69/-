...
cv2.createTrackbar('min_height', 'size', 0, 100, nothing)
cv2.createTrackbar('min_width', 'size', 0, 100, nothing)

cv2.createTrackbar('max_height', 'size', 0, 100, nothing)
cv2.createTrackbar('max_width', 'size', 0, 100, nothing)
...
while True:
	...
	max_width = cv2.getTrackbarPos('max_width', 'sizer')
